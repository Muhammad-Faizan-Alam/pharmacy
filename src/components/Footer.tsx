...
export function Footer() {
  return (
    <footer className="bg-[#75aa22] border-t text-white border-gray-200 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        {/* Customer Service */}
        <div className="space-y-4">
          <h2 className="text-lg font-semibold hover:font-bold cursor-pointer">
            Customer Service
          </h2>
        ...
        <div className="space-y-4">
          ...
          <address className="not-italic space-y-2 text-white cursor-pointer  transition">
